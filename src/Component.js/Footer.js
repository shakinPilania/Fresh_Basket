...
function Footer() {
  ...
  return (
    <div className=' bg-stone-900 text-stone-300 mt-16' >
      {/* top */}
      <div className='flex flex-row  justify-around mb-10 gap-10 px-6 py-14 ' >
        {/* left */}
        <div className="flex flex-col justify-evenly gap-4 plusJakarta " >
          ...
          <div className="flex flex-row gap-3 text-white items-center " >
            ...
            <button className="w-8 h-8 rounded-lg bg-stone-800 hover:bg-green-600 transition-all duration-300"  ><FaGithub className="w-full mx-auto "  size={20}/></button>
      ...
      <div className='flex flex-row justify-between items-center mt-3 min-h-[100px]' >
        <div>
          <span className='px-17 mt-5 plusJakarta text-xs text-[#79716B]' >© 2025 FreshBasket. All rights reserved.</span>
        </div>
