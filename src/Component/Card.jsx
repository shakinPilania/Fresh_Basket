...
function Card({featured,category}) {
    ...
    function orderTo()
    {
        addToBasket({id:featured.id,name:featured.name , category :featured.category , unit:featured.unit , countQty:{count:1} , price:featured.price , emoji:featured.emoji , bg:featured.bg });
